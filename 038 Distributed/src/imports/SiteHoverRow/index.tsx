import svgPaths from "./svg-p14ydnmsuu";
...
function TableCell({ className, content = "Text", iconLeft = true, iconRight = true, state = "Default", text = "Text", type = "Not Selected" }: TableCellProps) {
  const isBadgeAndNotSelectedAndHover = content === "Badge" && type === "Not Selected" && state === "Hover";
  ...
  return (
    <div className={className || `relative ${content === "Space [Empty Cell]" && type === "Not Selected" && state === "Hover" ? "bg-[#fafafa] size-[48px]" : content === "Space [Empty Cell]" && type === "Not Selected" && state === "Default" ? "size-[48px]" : type === "Not Selected" && state === "Hover" && ["Text", "Badge", "More Button", "Checkbox"].includes(content) ? "bg-[#fafafa]" : ""}`}>
      <div className={`flex size-full ${isSpaceEmptyCellAndNotSelected ? "flex-row items-end" : "flex-col justify-center"}`}>
        <div className={`content-stretch flex relative size-full ${isSpaceEmptyCellAndNotSelected ? "items-end" : "flex-col items-start justify-center"}`}>
          {type === "Not Selected" && (content === "Text" || (content === "Badge" && state === "Hover") || content === "More Button" || content === "Checkbox") && (
            <div className={`content-stretch flex relative shrink-0 ${isCheckboxAndNotSelected ? "items-start justify-center pb-[15px] pt-[16px]" : isMoreButtonAndNotSelected ? "items-center pb-[7px] pt-[8px]" : isBadgeAndNotSelectedAndHover ? "items-center pb-[11px] pt-[12px]" : "gap-[8px] items-center pb-[13px] pt-[14px]"}`} data-name="container">
              ...
              {isBadgeAndNotSelectedAndHover && <Badge className="relative rounded-[6px] shrink-0" />}
            </div>
          )}
      ...
      <div className="content-stretch flex flex-col items-start relative size-full">
        <div className="h-[24px] relative shrink-0 w-[150px]" data-name="logotype">
          <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 150 24" width="150">
            <g clipPath="url(#clip0_0_1018)" id="logotype">
...
function Col13() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0" data-name="col">
      ...
      <div className="bg-[#fafafa] relative shrink-0 w-full" data-name="table cell">
        <div className="flex flex-col justify-center size-full">
          <div className="content-stretch flex flex-col items-start justify-center relative size-full">
            <Container40 />
            <div className="bg-[#e6e6e6] h-px relative shrink-0 w-full" data-name="divider" />
...
export default function SiteHoverRow() {
  return (
    <div className="relative size-full" data-name="site hover row">
      <LocalPageSites />
    </div>
  );
}