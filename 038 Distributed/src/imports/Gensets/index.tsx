import svgPaths from "./svg-iotl70w2z9";
      ...
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name=".local -icon -genset">
        <div className="-translate-x-1/2 absolute bottom-[20.83%] left-1/2 top-[29.17%] w-[15px]" data-name="vector">
          <div className="absolute inset-[-7.5%_-5%]">
            <svg className="block size-full" fill="none" height="11.5" preserveAspectRatio="none" viewBox="0 0 16.5 11.5" width="16.5">
              <path d={svgPaths.p29df13f0} id="vector" stroke="#0A0A0A" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
        <div className="-translate-x-1/2 absolute bottom-[31.25%] left-[calc(50%-3.33px)] top-[37.5%] w-[5px]" data-name="vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="6.25" preserveAspectRatio="none" viewBox="0 0 5 6.25" width="5">
            <path d={svgPaths.pae1d180} fill="#0A0A0A" id="vector" />
          </svg>
        </div>
        <div className="absolute h-[1.667px] left-[4.17px] top-[15.83px] w-[2.5px]">
          <div className="absolute inset-[-45%_-30%]">
            <svg className="block size-full" fill="none" height="3.16667" preserveAspectRatio="none" viewBox="0 0 4 3.16667" width="4">
              <path d={svgPaths.p27204800} id="Rectangle 1" stroke="#0A0A0A" strokeLinejoin="round" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
        ...
        <div className="absolute left-[11.67px] size-[3.333px] top-[2.5px]">
          <div className="absolute inset-[-22.5%]">
            <svg className="block size-full" fill="none" height="4.83333" preserveAspectRatio="none" viewBox="0 0 4.83333 4.83333" width="4.83333">
              <path d={svgPaths.p129b6d00} id="Rectangle 3" stroke="#0A0A0A" strokeLinejoin="round" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
        <div className="absolute h-0 left-[10px] top-[2.5px] w-[6.667px]">
          <div className="absolute inset-[-0.75px_-11.25%]">
            <svg className="block size-full" fill="none" height="1.5" preserveAspectRatio="none" viewBox="0 0 8.16667 1.5" width="8.16667">
              <path d="M0.75 0.75H7.41667" id="Vector 1" stroke="#0A0A0A" strokeLinecap="round" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
        <div className="absolute h-0 left-[11.67px] top-[9.17px] w-[3.333px]">
          <div className="absolute inset-[-0.75px_-22.5%]">
            <svg className="block size-full" fill="none" height="1.5" preserveAspectRatio="none" viewBox="0 0 4.83333 1.5" width="4.83333">
              <path d="M0.75 0.75H4.08333" id="Vector 2" stroke="#0A0A0A" strokeLinecap="round" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
        <div className="absolute h-0 left-[11.67px] top-[12.5px] w-[3.333px]">
          <div className="absolute inset-[-0.75px_-22.5%]">
            <svg className="block size-full" fill="none" height="1.5" preserveAspectRatio="none" viewBox="0 0 4.83333 1.5" width="4.83333">
              <path d="M0.75 0.75H4.08333" id="Vector 3" stroke="#0A0A0A" strokeLinecap="round" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
      </div>
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.084px] whitespace-nowrap">Gensets</p>
    </div>
  );
}
      ...
      <div className="relative rounded-[6px] shrink-0" data-name="page title">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center relative size-full">
            ...
            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[28px] not-italic relative shrink-0 text-[#0a0a0a] text-[20px] tracking-[-0.34px] whitespace-nowrap">Gensets</p>
          </div>
        </div>
      </div>
...
function Container12() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#757575] text-[14px] tracking-[-0.084px] whitespace-pre">{`Genset  ID`}</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pb-[13px] pt-[14px] relative shrink-0" data-name="container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.084px] whitespace-nowrap">GS-800</p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pb-[13px] pt-[14px] relative shrink-0" data-name="container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.084px] whitespace-nowrap">GS-799</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pb-[13px] pt-[14px] relative shrink-0" data-name="container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.084px] whitespace-nowrap">GS-798</p>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pb-[13px] pt-[14px] relative shrink-0" data-name="container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.084px] whitespace-nowrap">GS-797</p>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pb-[13px] pt-[14px] relative shrink-0" data-name="container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.084px] whitespace-nowrap">GS-796</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pb-[13px] pt-[14px] relative shrink-0" data-name="container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.084px] whitespace-nowrap">GS-795</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#757575] text-[14px] tracking-[-0.084px] whitespace-nowrap">Charging status</p>
    </div>
  );
}
          ...
          <div className="relative rounded-[6px] shrink-0" data-name="badge">
            ...
            <div className="flex flex-row items-center size-full">
              <div className="content-stretch flex gap-[8px] items-center px-[8px] py-[2px] relative size-full">
                ...
                <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#757575] text-[14px] tracking-[-0.084px] whitespace-nowrap">Standby</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="relative rounded-[6px] shrink-0" data-name="badge">
            ...
            <div className="flex flex-row items-center size-full">
              <div className="content-stretch flex gap-[8px] items-center px-[8px] py-[2px] relative size-full">
                ...
                <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.084px] whitespace-nowrap">Running</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[24px] items-center pb-[8px] relative size-full">
            <div className="flex-[1_0_0] min-w-px relative" data-name=".local -forsearchflow -tabletitle -title">
              <div className="flex flex-row items-center size-full">
                <div className="content-stretch flex items-center relative size-full">
                  <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] tracking-[-0.084px] whitespace-nowrap">6 Gensets</p>
                </div>
              </div>
            </div>
            <Right />
...
export default function Gensets() {
  return (
    <div className="bg-white overflow-clip relative rounded-[20px] size-full" data-name="Gensets">
      <Header />
      <Container4 />
    </div>
  );
