import svgPaths from "./svg-pkpcvn9v58";
      ...
      <div className="content-stretch flex flex-col items-start relative size-full">
        <div className="h-[24px] relative shrink-0 w-[150px]" data-name="logotype">
          <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 150 24" width="150">
            <g clipPath="url(#clip0_0_1138)" id="logotype">
...
function Content3() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="content">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[-0.084px] whitespace-nowrap">Chargers</p>
    </div>
  );
}
...
function Col18() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-[240px] overflow-clip relative" data-name="col">
      <div className="h-[48px] relative rounded-[6px] shrink-0 w-full" data-name="table header">
        <div className="flex flex-col justify-center size-full">
          <div className="content-stretch flex flex-col items-start justify-center relative size-full">
            <Container95 />
...
function Container4() {
  return (
    <div className="absolute content-stretch flex gap-[48px] h-[514px] items-start left-0 px-[24px] right-0 top-[61px]" data-name="container">
      <Container5 />
      <Container6 />
    </div>
  );
...
export default function Units() {
  return (
    <div className="bg-white overflow-clip relative rounded-[20px] size-full" data-name="Units">
      <Header />
      <Container4 />
    </div>
  );
