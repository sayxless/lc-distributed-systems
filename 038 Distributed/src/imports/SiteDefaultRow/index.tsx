import svgPaths from "./svg-zmaa90blmd";
      ...
      <div className="content-stretch flex flex-col items-start relative size-full">
        <div className="h-[24px] relative shrink-0 w-[150px]" data-name="logotype">
          <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 150 24" width="150">
            <g clipPath="url(#clip0_0_994)" id="logotype">
...
export default function SiteDefaultRow() {
  return (
    <div className="relative size-full" data-name="site default row">
      <LocalPageSites />
    </div>
  );
}